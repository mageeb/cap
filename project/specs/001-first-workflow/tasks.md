...
Code review setup choices await review: [DEC-006: source and discovery](../../../DECISIONS.md#dec-006-code-review-skill-source-and-discovery) and [DEC-007: independent refutation](../../../DECISIONS.md#dec-007-independent-review-and-refutation). Use the [review prompt](../../docs/workflow.md#4-implement-and-review) for implementation; product definition is still the next task.

PR dependency arrangement awaits review in [DEC-008](../../../DECISIONS.md#dec-008-pull-request-stack-and-policy-placement). The complete setup branch is `feature/pr-commit-series`; the [workflow guide](../../docs/workflow.md#4-implement-and-review) records the separate series and PR bases.
